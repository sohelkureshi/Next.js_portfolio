    ...
    >
      ...
      <div className="mb-14 rounded-3xl border border-slate-200 bg-white/95 backdrop-blur-xl shadow-xl p-8 md:p-10">
        ...
        <p className="text-sm md:text-base text-slate-700 leading-relaxed">
          ...
          Skilled in the MERN stack, secure authentication, REST APIs, and modern web technologies. Completed internships and launched
      ...
      <div className="mb-14">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm hover:shadow-md transition-all">
            <div className="mb-3 inline-flex items-center justify-center w-9 h-9 rounded-xl bg-slate-900 text-white">
              {/* mortarboard icon */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          {/* Technical Skills */}
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm hover:shadow-md transition-all">
            <div className="mb-3 inline-flex items-center justify-center w-9 h-9 rounded-xl bg-emerald-50 text-emerald-700 border border-emerald-200">
              {/* tools icon */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-4.5 h-4.5"
                ...
                strokeLinejoin="round"
              >
                <path d="M15 3.5 13.5 5l2 2-2 2L14 10l3-3 1.5 1.5a3.5 3.5 0 0 1-3.4 5.8L12 18.5 5.5 12 8.2 9.1A3.5 3.5 0 0 1 14 5.2z" />
                <path d="m5.5 12-2 2L8 18.5l2-2" />
              </svg>
            </div>
          ...
          {/* Projects */}
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm hover:shadow-md transition-all">
            <div className="mb-3 inline-flex items-center justify-center w-9 h-9 rounded-xl bg-slate-100 text-slate-800 border border-slate-200">
              {/* folder icon */}
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="w-4.5 h-4.5"
